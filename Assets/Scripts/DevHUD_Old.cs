/* OLD DEVHUD - PRESERVED FOR REFERENCE
 * This is the old polling-based DevHUD that directly accessed singletons
 * Replaced with event-driven architecture using DevHudAdapter
 *
using UnityEngine;
using System.Linq;

public class DevHUD_Old : MonoBehaviour
{
